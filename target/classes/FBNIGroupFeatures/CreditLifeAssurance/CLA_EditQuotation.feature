...
Feature: Quotation Date of Birth Validation
  ...
  Scenario Outline: DOB Validation
   Given User is on http://172.28.162.17:6001/LMSGroup/
    ...
    #And user inputs wrong date format as 29/11/1998
    #Then System displays error message:Error: The date is not in the correct format.
    #When user inputs right date format as 29/11/1998
